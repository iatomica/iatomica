...
import { Sparkles, Calendar, Menu, X, ArrowRight, Sun, Moon, Cpu, ShieldAlert } from 'lucide-react';
...
export const Navbar: React.FC<NavbarProps> = ({ onOpenAiChat, onOpenAdmin, darkMode, onToggleDarkMode }) => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center space-x-3">
          ...
          <button
            ...
            title="Abrir Panel CRM de Administración"
          >
            <ShieldAlert size={14} />
            <span>Admin CRM</span>
          </button>
          ...
          {/* Calendly Official Direct Action */}
          <a
            href={calendlyUrl}
            target="_blank"
            rel="noreferrer"
          ...
          >
            ...
            <span>Agendar Cita (Calendly)</span>
      ...
      {mobileMenuOpen && (
        <div className={`md:hidden p-5 mt-3 border-b space-y-4 ${darkMode ? 'bg-slate-900 border-slate-800' : 'bg-white border-slate-200'}`}>
          ...
          <div className="pt-3 border-t flex flex-col space-y-2">
            ...
            >
              <ShieldAlert size={14} />
              <span>Abrir Panel Admin CRM</span>
            </button>
            <a
              href={calendlyUrl}
              target="_blank"
